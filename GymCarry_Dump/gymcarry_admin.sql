...
CREATE TABLE `admin` (
  ...
  `adminid` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `adminpw` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
-- Dump completed on 2021-09-26 22:47:33
